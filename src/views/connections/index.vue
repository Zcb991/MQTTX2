<template>
  <div class="connections">
    <!-- <div class="left-list" v-if="getterShowConnections"> -->
    <div class="left-list" v-show="getterShowConnections">
...
export default class Connections extends Vue {
  ...
  // private isShowConnectionsList: boolean = this.getterShowConnections
  // private isShowConnectionsList: boolean = true
  ...
  private created() {
    ...
    // this.isShowConnectionsList = this.getterShowConnections 
    console.log('getterShowConnections:', this.getterShowConnections)
    // console.log('加载的isShowConnectionsList', this.isShowConnectionsList)
  }
}
</script>
