...
const TOGGLE_CONNECTIONS_VISIBLE = 'TOGGLE_CONNECTIONS_VISIBLE'
...
const app = {
  ...
  mutations: {
    ...
    [TOGGLE_CONNECTIONS_VISIBLE](state: App, showConnections: boolean) {
  ...
  actions: {
    ...
    async TOGGLE_CONNECTIONS_VISIBLE({ commit }: any, payload: App) {
      commit(TOGGLE_CONNECTIONS_VISIBLE, payload.showConnections)
    },
