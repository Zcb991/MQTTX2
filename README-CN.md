...
[MQTTX](https://mqttx.app/zh) 是 [EMQ](https://www.emqx.com/zh) 开源的一款跨平台 MQTT 5.0 客户端工具，它支持 macOS, Linux, Windows，并且支持 MQTT 消息格式转换。
...
支持按照类型（全部、已接收、已发送）显示数量

支持按照搜索显示数量（主题点击是精确搜索，输入框中的topic是模糊搜索）

![1697540012935](image/README-CN/1697540012935.png)

![1697540021282](image/README-CN/1697540021282.png)

![1697540119634](image/README-CN/1697540119634.png)

![1697540142787](image/README-CN/1697540142787.png)
